  ...
  <div class="col-md-12">
    <div class="navbar-header">
      ...
      <ul class="nav dropdown-menu">
        <li><a href="http://zhangteng.yifangyun.com"><i class="glyphicon glyphicon-home" style="color:#dd1111;"></i> Home </a></li>
        <li><a href="http://zhangteng.yifangyun.com/index.php/home/record"><i class="glyphicon glyphicon-user" style="color:#1111dd;"></i> Profile</a></li>
        <li><a href="http://zhangteng.yifangyun.com/index.php/wishlist/archive"><i class="glyphicon glyphicon-dashboard" style="color:#0000aa;"></i> Wish List</a></li>
