	...
	<div class="container" id="main">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<p>
							<img src="//placehold.it/150x150" class="img-circle pull-right"> <a href="#">The Bootstrap Playground</a></p>
						<div class="clearfix"></div>
						<hr> Design, build, test, and prototype using Bootstrap in real-time from your Web browser. Bootply combines the power of hand-coded HTML, CSS and JavaScript with the benefits of responsive design using Bootstrap. Find and showcase Bootstrap-ready snippets
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<p>If you're looking for help with Bootstrap code, the
							<code>twitter-bootstrap</code> tag at <a href="http://stackoverflow.com/questions/tagged/twitter-bootstrap">Stackoverflow</a> is a good place to find answers.</p>
			...
			<div class="col-md-4 col-sm-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="clearfix"></div>
						<hr>
						<p>Migrating from Bootstrap 2.x to 3 is not a simple matter of swapping out the JS and CSS files. Bootstrap 3 is a major overhaul, and there are a lot of changes from Bootstrap 2.x. <a href="http://bootply.com/bootstrap-3-migration-guide">This guidance</a>							is intended to help 2.x developers transition to 3.
						</p>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<p>
										...
										<span class="label label-primary">89 followers</span>
									</p>
									<p>
										<a href="#" class="btn btn-xs btn-default">
											<span class="glyphicon glyphicon-comment"></span> Message</a>
										<a href="#" class="btn btn-xs btn-default">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="panel panel-default">
					<div class="panel-thumbnail">
						<img src="//placehold.it/450/EDEDED" class="img-responsive">
					</div>
					<div class="panel-body">
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="panel panel-default">
					<div class="panel-thumbnail">
						<img src="//placehold.it/450/DD66DD/FFF" class="img-responsive">
					</div>
					<div class="panel-body">
			...
			<div class="col-sm-4 col-xs-6">
				...
				<div class="panel panel-default">
					<div class="panel-thumbnail">
						<img src="//placehold.it/450/2222CC/EEE" class="img-responsive">
					</div>
					<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-md-12 text-center">
				<p><a href="http://www.bootply.com/download/90113" target="_ext">Download Google Plus Style Template</a>
					<br><a href="http://bootply.com/templates" target="_ext">More Bootstrap Templates by @Bootply</a></p>
			</div>
			<hr>
